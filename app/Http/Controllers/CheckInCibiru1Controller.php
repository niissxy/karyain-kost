    ...
    public function store(Request $request)
{
   ...
   $lastTransaksi = TransaksiCibiru1::latest('id_transaksi')->first();
    ...
    return redirect()->route('checkin_cibiru1.index')
        ->with('success', 'Data Check-In Kost Cibiru 1 Berhasil Ditambahkan.');
}
  ...
  public function update(Request $request, string $id_checkin) {
    ...
    DB::transaction(function () use ($request, $id_checkin) {
        ...
        if ($request->status === 'Check out') {
            ...
            $cekCheckout = DB::table('checkout_cibiru1')
            ...
            PenghuniCibiru1::where('nama_penghuni', $request->nama_penghuni)
    ...
    return redirect()->route('checkin_cibiru1.index')
        ->with('success', 'Data Check-In Kost Cibiru 1 Berhasil Diperbarui.');
}
