...
use App\Models\LapKamarCibiru2;
use App\Models\User;
    ...
    public function index()
{
    ...
    $jumlahKamarTerisi = DB::table('lap_kamar_cibiru2')
        ->where('status_kamar', 'terisi')
        ->count();

    $jumlahKamarKosong = DB::table('lap_kamar_cibiru2')
        ->where('status_kamar', 'kosong')
        ->count();

    $jumlahKamarDibooking = DB::table('lap_kamar_cibiru2')
        ->where('status_kamar', 'booked')
        ->count();

    return view('lapkamar_cibiru2.index', compact(
        'lapkamar_cibiru2',
        'jumlahKamarTerisi',
        'jumlahKamarKosong',
...
public function create()
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('lapkamar_cibiru2.index')
                         ->with('success', 'Data Laporan Kamar Kost Cibiru 2 Berhasil Ditambahkan.');
    }
