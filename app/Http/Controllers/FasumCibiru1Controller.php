...
class FasumCibiru1Controller extends Controller
{
    ...
    public function create()
    {
        ...
        $lastKode = FasumCibiru1::latest()->first();
     ...
     return view('fasum_cibiru1.create', compact('asetFasilitasUmum', 'newKode'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('fasum_cibiru1.index')
            ->with('success', 'Data Fasilitas Umum Kost Cibiru 1 Berhasil Ditambahkan.');
    }
