...
if ($penghuni) {
    ...
    {
        // $checkout_regol2 = CheckOutRegol2::where('id_checkout', $id_checkout)->firstOrFail();
        // return view('checkout_regol2.show', compact('checkout_regol2'));
    }
    ...
    if (!$checkin) {
        return back()->with('error', 'Data Check-In Kost Regol 2 Tidak Ditemukan.');
    }
    ...
    return redirect()
        ...
        ->with('success', 'Data Check-Out Kost Regol 2 Berhasil Diperbarui.');
}
