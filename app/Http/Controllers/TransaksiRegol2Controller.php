...
class TransaksiRegol2Controller extends Controller
{
    ...
    {
        $transaksi_regol2 = TransaksiRegol2::with('user')->get();
    ...
    public function create()
    {
        ...
        $lastKode = TransaksiRegol2::latest()->first();
        ...
        return view('transaksi_regol2.create', compact('user', 'newKode'));
    }
    ...
    public function update(Request $request, string $id_transaksi)
    {
        ...
        TransaksiRegol2::where('id_transaksi', $id_transaksi)
            ->update([
