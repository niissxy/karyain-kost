        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./penghuni_regol1">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data penghuni Kost Regol 1
                </li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Penghuni Kost Regol 1</h5>
                <!-- <a href="{{ url('penghuni_regol1/create') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            @foreach ($penghuni_regol1 as $item)
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('penghuni_regol1/' . $item->id_penghuni . '/edit') }}" 
                                     ...
                                     <!-- Tombol Delete -->
                                        ...
                                        onclick="confirmDelete('{{ $item->id_penghuni }}')"></button>
                                        &nbsp;
                                    </div>
                                </td>
                            </tr>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
        <script src="https://code.jquery.com/jquery-3.6.0.min.js"
            integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
                        ...
                        @endif
                        <script>
            function confirmDelete(id_penghuni) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('penghuni_regol1.destroy', ':id_penghuni') }}".replace(':id_penghuni', id_penghuni);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
