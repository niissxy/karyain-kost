        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./transaksi_regol2">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data Transaksi Kost Regol 2
                </li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Transaksi Kost Regol 2</h5>
                <!-- <a href="{{ url('transaksi_regol2/create') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            @foreach ($transaksi_regol2 as $item)
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('transaksi_regol2/' . $item->id_transaksi . '/edit') }}" 
            ...
            function confirmDelete(id_transaksi) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('transaksi_regol2.destroy', ':id_transaksi') }}".replace(':id_transaksi', id_transaksi);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
