                ...
                <div class="col-md-10">
                    <ol class="breadcrumb float-md-end small mb-4 mt-4">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Tambah Data Transaksi Kost Regol 2
                        </li>
                    </ol>
                </div>
            </div> 
            ...
            <div class="col-lg-8 col-md-10 col-sm-12">
                ...
                <div class="card card-warning card-outline">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Tambah Data Transaksi Kost Regol 2</h5>
                        <a class="btn btn-warning btn-sm" href="{{ url('./transaksi_regol2') }}">
                            <i class="bi bi-arrow-left-circle-fill"></i> Back
                        </a>
                    </div>

                    <form action="{{ url('transaksi_regol2') }}" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
