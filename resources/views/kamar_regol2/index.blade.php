    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Kamar Kost Regol 2</h5>
                <a href="{{ url('kamar_regol2/create') }}" class="btn btn-warning btn-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('kamar_regol2/' . $item->id_kamar . '/edit') }}" 
                                     ...
                                     <!-- Tombol Delete -->
                                        ...
                                        onclick="confirmDelete('{{ $item->id_kamar }}')"></button>
                                        &nbsp;
                                    </div>
                                </td>
                            </tr>
            ...
            function confirmDelete(id_kamar) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('kamar_regol2.destroy', ':id_kamar') }}".replace(':id_kamar', id_kamar);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
