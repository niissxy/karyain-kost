        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./faskamar_regol2">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data Fasilitas Kamar Kost Regol 2
                </li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Fasilitas Kamar Kost Regol 2</h5>
                <a href="{{ url('faskamar_regol2/create') }}" class="btn btn-warning btn-sm">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            @foreach ($faskamar_regol2 as $item)
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('faskamar_regol2/' . $item->id_fask . '/edit') }}" 
            ...
            function confirmDelete(id_fask) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('faskamar_regol2.destroy', ':id_fask') }}".replace(':id_fask', id_fask);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
