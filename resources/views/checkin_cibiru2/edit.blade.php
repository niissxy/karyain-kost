                    ...
                    <form action="{{ url('checkin_cibiru2/' .$checkin_cibiru2->id_checkin) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" value="{{ old('tgl_checkout',$checkin_cibiru2->tgl_checkout) }}"  name="tgl_checkout"  required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="time" class="form-control" value="{{ old('jam_checkin',$checkin_cibiru2->jam_checkin) }}"  name="jam_checkin"  required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="time" class="form-control" value="{{ old('jam_checkout',$checkin_cibiru2->tgl_checkout) }}"  name="tgl_checkout"  required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" step="0.01" class="form-control" value="{{ old('nominal', number_format($checkin_cibiru2->nominal ?? 0, 0, ',', '.')) }}"  name="nominal"  required autofocus>
                                </div>
                            </div>
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="metode_pembayaran" name="metode_pembayaran">
                                        <option value='BCA' {{ old('metode_pembayaran', $checkin_cibiru2->metode_pembayaran) == 'BCA' ? 'selected' : '' }}>BCA</option>
                                        <option value='BRI' {{ old('metode_pembayaran', $checkin_cibiru2->metode_pembayaran) == 'BRI' ? 'selected' : '' }}>BRI</option>
                                        <option value='BNI' {{ old('metode_pembayaran', $checkin_cibiru2->metode_pembayaran) == 'BNI' ? 'selected' : '' }}>BNI</option>
                                        <option value='Mandiri' {{ old('metode_pembayaran', $checkin_cibiru2->metode_pembayaran) == 'Mandiri' ? 'selected' : '' }}>Mandiri</option>
                                        <option value='BTPN/JENIUS' {{ old('metode_pembayaran', $checkin_cibiru2->metode_pembayaran) == 'BTPN/JENIUS' ? 'selected' : '' }}>BTPN/JENIUS</option>
                                        <option value='BSI' {{ old('metode_pembayaran', $checkin_cibiru2->metode_pembayaran) == 'BSI' ? 'selected' : '' }}>BSI</option>
                                        <option value='Bank Jago' {{ old('metode_pembayaran', $checkin_cibiru2->metode_pembayaran) == 'Bank Jago' ? 'selected' : '' }}>Bank Jago</option>
