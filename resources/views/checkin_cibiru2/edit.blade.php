                    ...
                    <form action="{{ url('checkin_cibiru2/' .$checkin_cibiru2->id_checkin) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" value="{{ old('tgl_checkout',$checkin_cibiru2->tgl_checkout) }}" name="tgl_checkout" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" value="{{ old('total_penyewa',$checkin_cibiru2->total_penyewa) }}" name="total_penyewa" required autofocus>
                                </div>
                            </div>
