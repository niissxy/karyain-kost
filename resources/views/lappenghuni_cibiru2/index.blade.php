@extends('layouts.app')
@section('title', 'Laporan Penghuni Kost Cibiru 2')
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ url('lappenghuni_cibiru2') }}">Master Data</a>
                    </li>
                    <li class="breadcrumb-item active">
                        Laporan Penghuni Kost Cibiru 2
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="center-wrapper" style="margin-right: 125px;">
            <div class="card table-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Laporan Penghuni Kost Cibiru 2</h5>
                    <a href="{{ url('lappenghuni_cibiru2/create') }}"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            ...
                            <tbody>
                                @foreach ($lappenghuni_cibiru2 as $item)
                                <tr>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
        <script src="https://code.jquery.com/jquery-3.6.0.min.js"
            integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
                        ...
                        @endif
                        <script>
            function confirmDelete(id_lappenghuni) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('lappenghuni_cibiru2.destroy', ':id_lappenghuni') }}".replace(':id_lappenghuni', id_lappenghuni);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
