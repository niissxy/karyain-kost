        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./aset_regol1">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data Aset Kost Regol 1
                </li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Aset Kost Regol 1</h5>
                <a href="{{ url('aset_regol1/create') }}" class="btn btn-warning btn-sm">
                            ...
                            <tr>
                                ...
                                <td>{{ $item->kondisi }}</td>
                                 ...
                                 <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('aset_regol1/' . $item->id_aset . '/edit') }}" 
            ...
            function confirmDelete(id_aset) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('aset_regol1.destroy', ':id_aset') }}".replace(':id_aset', id_aset);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
