@extends('layouts.app')
@section('title', 'Data Penghuni Kost Regol 2')
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Penghuni Kost Regol 2</h5>
                <!-- <a href="{{ url('penghuni_regol2/create') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            @foreach ($penghuni_regol2 as $item)
                            <tr>
            ...
            function confirmDelete(id_penghuni) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('penghuni_regol2.destroy', ':id_penghuni') }}".replace(':id_penghuni', id_penghuni);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
