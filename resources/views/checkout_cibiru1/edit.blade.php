                ...
                <div class="col-md-10">
                    <ol class="breadcrumb float-md-end small mb-4 mt-4">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Edit Data Check Out Kost Cibiru 1
                        </li>
                    </ol>
                </div>
            </div> 
            ...
            <div class="col-lg-8 col-md-10 col-sm-12">
                ...
                <div class="card card-warning card-outline">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Edit Data Check Out Kost Cibiru 1</h5>
                        <a class="btn btn-warning btn-sm" href="{{ url('./checkout_cibiru1') }}">
                            <i class="bi bi-arrow-left-circle-fill"></i> Back
                        </a>
                    </div>

                    <form action="{{ url('checkout_cibiru1/' . $checkout_cibiru1->id_checkout) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control"
                    value="{{ $checkout_cibiru1->id_checkout }}"
                    readonly>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                ...
                onchange="hitungLamaTinggal(this.value)" 
                    name="tgl_checkout"
                    value="{{ old('tgl_checkout', $checkout_cibiru1->tgl_checkout) }}"
                    required>
            </div>
        </div>
        ...
        <div class="row mb-3">
           ...
           <input type="hidden" id="tgl_checkin"
                value="{{ $checkout_cibiru1->checkin->tgl_checkin }}">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="time" class="form-control"
                    value="{{ $checkout_cibiru1->jam_checkout }}"
                    readonly>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control"
                    value="{{ $checkout_cibiru1->nama_penghuni }}"
                    readonly>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control"
                    value="{{ $checkout_cibiru1->no_kamar }}"
                    readonly>
            </div>
        </div>
