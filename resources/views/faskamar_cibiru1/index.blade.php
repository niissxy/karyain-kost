        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./faskamar_cibiru1">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data Fasilitas Kamar Kost Cibiru 1
                </li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url('faskamar_cibiru1/create') }}" class="btn btn-warning btn-sm">
            ...
            function confirmDelete(id_fask) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('faskamar_cibiru1.destroy', ':id_fask') }}".replace(':id_fask', id_fask);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
