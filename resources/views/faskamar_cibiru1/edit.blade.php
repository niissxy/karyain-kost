@extends('layouts.app')
@section('title', 'Data Fasilitas Kamar Kost Cibiru 1')
@section('content')
                    ...
                    <form action="{{ url('faskamar_cibiru1/' .$faskamar_cibiru1->id_fask) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" aria-readonly="" value="{{ old('nama_fasilitas',$faskamar_cibiru1->nama_fasilitas) }}"  name="nama_fasilitas" readonly required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" readonly value="{{ old('no_kamar',$faskamar_cibiru1->no_kamar) }}"  name="no_kamar"  required autofocus>
                                </div>
                            </div>
