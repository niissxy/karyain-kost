        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./aset_regol2">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data Aset Kost Regol 2
                </li>
            </ol>
        </nav>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('aset_regol2/' . $item->id_aset . '/edit') }}" 
            ...
            function confirmDelete(id_aset) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('aset_regol2.destroy', ':id_aset') }}".replace(':id_aset', id_aset);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
