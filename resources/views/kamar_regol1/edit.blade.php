                    ...
                    <form action="{{ url('kamar_regol1/' .$kamar_regol1->id_kamar) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" value="{{ old('harga_harian',$kamar_regol1->harga_harian) }}"  name="harga_harian"  required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" value="{{ old('harga_bulanan',$kamar_regol1->harga_bulanan) }}"  name="harga_bulanan"  required autofocus>
                                </div>
                            </div>
