        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./fasum_cibiru1">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data Fasilitas Umum Kost Cibiru 1
                </li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Fasilitas Umum Kost Cibiru 1</h5>
                <a href="{{ url('fasum_cibiru1/create') }}" class="btn btn-warning btn-sm">
            ...
            function confirmDelete(id_fasum) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('fasum_cibiru1.destroy', ':id_fasum') }}".replace(':id_fasum', id_fasum);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
