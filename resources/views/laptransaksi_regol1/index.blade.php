@extends('layouts.app')
@section('title', 'Laporan Transaksi Kost Regol 1')
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ url('laptransaksi_regol1') }}">Master Data</a>
                    </li>
                    <li class="breadcrumb-item active">
                        Laporan Transaksi Kost Regol 1
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <section class="mb-4">
        <div class="center-wrapper">
            <div class="row justify-content-center summary-card">
                ...
                <!-- Pemasukan -->
               <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                    <div class="card text-white bg-info bg-gradient h-100 shadaow">
                        <div class="card-header">
        ...
        <div class="center-wrapper" style="margin-right: 125px;">
            <div class="card table-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Laporan Transaksi Kost Regol 1</h5>
                    <a href="{{ url('laptransaksi_regol1/create') }}"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            ...
                            <tbody>
                                @foreach ($laptransaksi_regol1 as $item)
                                <tr>
            ...
            function confirmDelete(id_laptransaksi) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('laptransaksi_regol1.destroy', ':id_laptransaksi') }}".replace(':id_laptransaksi', id_laptransaksi);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
