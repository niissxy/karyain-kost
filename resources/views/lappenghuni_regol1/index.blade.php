@extends('layouts.app')
@section('title', 'Laporan Penghuni Kost Regol 1')
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ url('lappenghuni_regol1') }}">Master Data</a>
                    </li>
                    <li class="breadcrumb-item active">
                        Laporan Penghuni Kost Regol 1
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="center-wrapper" style="margin-right: 125px;">
            <div class="card table-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Laporan Penghuni Kost Regol 1</h5>
                    <a href="{{ url('lappenghuni_regol1/create') }}"
            ...
            function confirmDelete(id_lappenghuni) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('lappenghuni_regol1.destroy', ':id_lappenghuni') }}".replace(':id_lappenghuni', id_lappenghuni);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
