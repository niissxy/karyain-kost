                ...
                <div class="col-md-10">
                    <ol class="breadcrumb float-md-end small mb-4 mt-4">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Tambah Data Check Out Kost Cibiru 2
                        </li>
                    </ol>
                </div>
            </div> 
            ...
            <div class="col-lg-8 col-md-10 col-sm-12">
                ...
                <div class="card card-warning card-outline">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Tambah Data Check Out Kost Cibiru 2</h5>
                        <a class="btn btn-warning btn-sm" href="{{ url('./checkout_cibiru2') }}">
                            <i class="bi bi-arrow-left-circle-fill"></i> Back
                        </a>
                    </div>

                    <form action="{{ url('checkout_cibiru2') }}" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" id="id_checkout" name="id_checkout" value="{{ old('id_checkout') }}">
                                </div>
                            </div>
...
document.getElementById('id_checkin').addEventListener('change', function () {
    ...
    let today = new Date();
    let lama = Math.floor((today - tglCheckin) / (1000 * 60 * 60 * 24));
