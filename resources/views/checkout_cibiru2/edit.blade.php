@extends('layouts.app')
@section('title', 'Data Check Out Kost Cibiru 2')
@section('content')
                ...
                <div class="col-md-10">
                    <ol class="breadcrumb float-md-end small mb-4 mt-4">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Edit Data Check Out Kost Cibiru 2
                        </li>
                    </ol>
                </div>
            </div> 
            ...
            <div class="col-lg-8 col-md-10 col-sm-12">
                ...
                <div class="card card-warning card-outline">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Edit Data Check Out Kost Cibiru 2</h5>
                        <a class="btn btn-warning btn-sm" href="{{ url('./checkout_cibiru2') }}">
                            <i class="bi bi-arrow-left-circle-fill"></i> Back
                        </a>
                    </div>

                    <form action="{{ url('checkout_cibiru2/' . $checkout_cibiru2->id_checkout) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control"
                    value="{{ $checkout_cibiru2->id_checkout }}"
                    readonly>
            </div>
        </div>
        ...
        <div class="row mb-3">
           ...
           <input type="hidden" id="tgl_checkin"
                value="{{ $checkout_cibiru2->checkin->tgl_checkin }}">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control"
                    value="{{ $checkout_cibiru2->nama_penghuni }}"
                    readonly>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="number" id="lama_tinggal" class="form-control"
                    name="lama_tinggal"
                    value="{{ old('lama_tinggal', $checkout_cibiru2->lama_tinggal) }}"
                    required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control"
                    value="{{ $checkout_cibiru2->no_kamar }}"
                    readonly>
            </div>
        </div>
