        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./penghuni_cibiru1">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data penghuni Kost Cibiru 1
                </li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Penghuni Kost Cibiru 1</h5>
                <!-- <a href="{{ url('penghuni_cibiru1/create') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            @foreach ($penghuni_cibiru1 as $item)
                            <tr>
            ...
            function confirmDelete(id_penghuni) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('penghuni_cibiru1.destroy', ':id_penghuni') }}".replace(':id_penghuni', id_penghuni);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
