@extends('layouts.app')
@section('title', 'Laporan Transaksi Kost Cibiru 2')
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ url('laptransaksi_cibiru2') }}">Master Data</a>
                    </li>
                    <li class="breadcrumb-item active">
                        Laporan Transaksi Kost Cibiru 2
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="center-wrapper" style="margin-right: 125px;">
            <div class="card table-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Laporan Transaksi Kost Cibiru 2</h5>
                    <a href="{{ url('laptransaksi_cibiru2/create') }}"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            ...
                            <tbody>
                                @foreach ($laptransaksi_cibiru2 as $item)
                                <tr>
            ...
            function confirmDelete(id_laptransaksi) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('laptransaksi_cibiru2.destroy', ':id_laptransaksi') }}".replace(':id_laptransaksi', id_laptransaksi);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
