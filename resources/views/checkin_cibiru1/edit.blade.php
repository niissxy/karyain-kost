                    ...
                    <form action="{{ url('checkin_cibiru1/' .$checkin_cibiru1->id_checkin) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" readonly value="{{ old('nama_penghuni',$checkin_cibiru1->nama_penghuni) }}"  name="nama_penghuni"  required autofocus>
                                </div>
                            </div>
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" readonly value="{{ old('no_kamar',$checkin_cibiru1->no_kamar) }}"  name="no_kamar"  required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="metode_pembayaran" name="metode_pembayaran">
                                        <option value='BCA' {{ old('metode_pembayaran', $checkin_cibiru1->metode_pembayaran) == 'BCA' ? 'selected' : '' }}>BCA</option>
                                        <option value='BRI' {{ old('metode_pembayaran', $checkin_cibiru1->metode_pembayaran) == 'BRI' ? 'selected' : '' }}>BRI</option>
                                        <option value='BNI' {{ old('metode_pembayaran', $checkin_cibiru1->metode_pembayaran) == 'BNI' ? 'selected' : '' }}>BNI</option>
                                        <option value='Mandiri' {{ old('metode_pembayaran', $checkin_cibiru1->metode_pembayaran) == 'Mandiri' ? 'selected' : '' }}>Mandiri</option>
                                        <option value='BTPN/JENIUS' {{ old('metode_pembayaran', $checkin_cibiru1->metode_pembayaran) == 'BTPN/JENIUS' ? 'selected' : '' }}>BTPN/JENIUS</option>
                                        <option value='BSI' {{ old('metode_pembayaran', $checkin_cibiru1->metode_pembayaran) == 'BSI' ? 'selected' : '' }}>BSI</option>
                                        <option value='Bank Jago' {{ old('metode_pembayaran', $checkin_cibiru1->metode_pembayaran) == 'Bank Jago' ? 'selected' : '' }}>Bank Jago</option>
