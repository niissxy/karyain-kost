            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ url('lapkamar_cibiru1') }}">Master Data</a>
                    </li>
                    <li class="breadcrumb-item active">
                        Laporan Kamar Kost Cibiru 1
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="center-wrapper" style="margin-right: 125px;">
            <div class="card table-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Laporan Kamar Kost Cibiru 1</h5>
                    <a href="{{ url('lapkamar_cibiru1/create') }}"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            ...
                            <tbody>
                                @foreach ($lapkamar_cibiru1 as $item)
                                <tr>
            ...
            function confirmDelete(id_lapkamar) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('lapkamar_cibiru1.destroy', ':id_lapkamar') }}".replace(':id_lapkamar', id_lapkamar);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
