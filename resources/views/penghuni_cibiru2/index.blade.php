        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./penghuni_cibiru2">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data penghuni Kost Cibiru 2
                </li>
            </ol>
        </nav>
    </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            @foreach ($penghuni_cibiru2 as $item)
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('penghuni_cibiru2/' . $item->id_penghuni . '/edit') }}" 
            ...
            function confirmDelete(id_penghuni) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('penghuni_cibiru2.destroy', ':id_penghuni') }}".replace(':id_penghuni', id_penghuni);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
