                    ...
                    <form action="{{ url('checkin_regol1/' .$checkin_regol1->id_checkin) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-9">
                                    <select name="no_kamar" class="form-control" required>
                                        ...
                                        <option value="{{ $k->no_kamar }}"
                                            {{ $checkin_regol1->no_kamar == $k->no_kamar ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" value="{{ old('total_penyewa',$checkin_regol1->total_penyewa) }}" name="total_penyewa" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" step="0.01" class="form-control" value="{{ old('nominal',$checkin_regol1->nominal) }}" name="nominal" required>
                                </div>
                            </div>
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="metode_pembayaran" name="metode_pembayaran">
                                        <option value='BCA' {{ old('metode_pembayaran', $checkin_regol1->metode_pembayaran) == 'BCA' ? 'selected' : '' }}>BCA</option>
                                        <option value='BRI' {{ old('metode_pembayaran', $checkin_regol1->metode_pembayaran) == 'BRI' ? 'selected' : '' }}>BRI</option>
                                        <option value='BNI' {{ old('metode_pembayaran', $checkin_regol1->metode_pembayaran) == 'BNI' ? 'selected' : '' }}>BNI</option>
                                        <option value='Mandiri' {{ old('metode_pembayaran', $checkin_regol1->metode_pembayaran) == 'Mandiri' ? 'selected' : '' }}>Mandiri</option>
                                        <option value='BTPN/JENIUS' {{ old('metode_pembayaran', $checkin_regol1->metode_pembayaran) == 'BTPN/JENIUS' ? 'selected' : '' }}>BTPN/JENIUS</option>
                                        <option value='BSI' {{ old('metode_pembayaran', $checkin_regol1->metode_pembayaran) == 'BSI' ? 'selected' : '' }}>BSI</option>
                                        <option value='Bank Jago' {{ old('metode_pembayaran', $checkin_regol1->metode_pembayaran) == 'Bank Jago' ? 'selected' : '' }}>Bank Jago</option>
