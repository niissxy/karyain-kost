...
<div class="invoice-container">
        ...
        <div class="invoice-info">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <p>{{ date('d-m-Y', strtotime($checkin_regol1->tgl_checkin)) }}</p>
                </div>
                <div class="col-sm-6">
                    <strong>Kode Check In :</strong>
                    <p>{{ $checkin_regol1->id_checkin }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <strong>Nama Penghuni :</strong>
                    <p>{{ $checkin_regol1->nama_penghuni }}</p>                   
                </div>
                <div class="col-sm-6">
                    <strong>No Kamar :</strong>
                    <p>{{ $checkin_regol1->no_kamar }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
        ...
        <a href="{{ route('checkin_regol1.index') }}" class="btn btn-secondary mt-3">Back</a>
        </div>
    </div>
</body>
</html>