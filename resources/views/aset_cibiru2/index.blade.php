        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./aset_cibiru2">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data Aset Kost Cibiru 2
                </li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Aset Kost Cibiru 2</h5>
                <a href="{{ url('aset_cibiru2/create') }}" class="btn btn-warning btn-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('aset_cibiru2/' . $item->id_aset . '/edit') }}" 
                                     ...
                                     <!-- Tombol Delete -->
                                        ...
                                        onclick="confirmDelete('{{ $item->id_aset }}')"></button>
                                        &nbsp;
                                    </div>
                                </td>
                            </tr>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
        <script src="https://code.jquery.com/jquery-3.6.0.min.js"
            integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
                        ...
                        @endif
                        <script>
            function confirmDelete(id_aset) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('aset_cibiru2.destroy', ':id_aset') }}".replace(':id_aset', id_aset);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
