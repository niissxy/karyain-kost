        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./checkout_regol2">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data Check Out Kost Regol 2
                </li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title">Data Check Out Kost Regol 2</h5>
                <a href="{{ url('checkout_regol2/create') }}" class="btn btn-warning btn-sm">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            @foreach ($checkout_regol2 as $item)
                            <tr>
                               ...
                               <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('checkout_regol2/' . $item->id_checkout . '/edit') }}" 
            ...
            function confirmDelete(id_checkout) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('checkout_regol2.destroy', ':id_checkout') }}".replace(':id_checkout', id_checkout);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
