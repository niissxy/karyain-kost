            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ url('lapkamar_regol1') }}">Master Data</a>
                    </li>
                    <li class="breadcrumb-item active">
                        Laporan Kamar Kost Regol 1
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="center-wrapper" style="margin-right: 125px;">
            <div class="card table-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Laporan Kamar Kost Regol 1</h5>
                    <a href="{{ url('lapkamar_regol1/create') }}"
            ...
            function confirmDelete(id_lapkamar) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('lapkamar_regol1.destroy', ':id_lapkamar') }}".replace(':id_lapkamar', id_lapkamar);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
