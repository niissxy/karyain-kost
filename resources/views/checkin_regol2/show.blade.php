        ...
        <div class="invoice-info">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <p>{{ date('d-m-Y', strtotime($checkin_regol2->tgl_checkin)) }}</p>
                </div>
                <div class="col-sm-6">
                    <strong>Kode Check In :</strong>
                    <p>{{ $checkin_regol2->id_checkin }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <strong>Nama Penghuni :</strong>
                    <p>{{ $checkin_regol2->nama_penghuni }}</p>                   
                </div>
                <div class="col-sm-6">
                    <strong>No Kamar :</strong>
                    <p>{{ $checkin_regol2->no_kamar }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <strong>Nominal :</strong>
                    <p>Rp {{ number_format($checkin_regol2->nominal, 0, ',', '.') }}</p>                    
                </div>
                <div class="col-sm-6">
                    <strong>Status :</strong>
                    <p>{{ $checkin_regol2->status }}</p>                    
                </div>
            </div>
      
        <div class="text-center mt-4">     
        <button class="btn btn-primary mt-3" onclick="window.print()">Print</button>
        <a href="{{ route('checkin_regol2.index') }}" class="btn btn-secondary mt-3">Back</a>
        </div>
    </div>
</body>
</html>