                    ...
                    <form action="{{ url('checkin_regol2/' .$checkin_regol2->id_checkin) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" value="{{ old('jam_checkout',$checkin_regol2->jam_checkout) }}" name="tgl_checkout" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="time" class="form-control" value="{{ old('jam_checkout',$checkin_regol2->jam_checkout  ) }}" name="jam_checkout" autofocus>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select name="no_kamar" class="form-control" required>
                                        ...
                                        <option value="{{ $k->no_kamar }}"
                                            {{ $checkin_regol2->no_kamar == $k->no_kamar ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" value="{{ old('total_penyewa',$checkin_regol2->total_penyewa) }}" name="total_penyewa" required autofocus>
                                </div>
                            </div>
