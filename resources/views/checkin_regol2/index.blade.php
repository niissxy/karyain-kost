    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url('checkin_regol2/create') }}" class="btn btn-warning btn-sm">
                    ...
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-body-secondary">Jam Check In</th>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('checkin_regol2/' . $item->id_checkin . '/edit') }}" 
                                         ...
                                         &nbsp;
                                        <a href="{{ route('checkin_regol2.exportPdf', $item->id_checkin) }}" 
            ...
            function confirmDelete(id_checkin) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('checkin_regol2.destroy', ':id_checkin') }}".replace(':id_checkin', id_checkin);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
