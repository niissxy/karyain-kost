            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ url('lappenghuni_cibiru1') }}">Master Data</a>
                    </li>
                    <li class="breadcrumb-item active">
                        Laporan Penghuni Kost Cibiru 1
                    </li>
                </ol>
            </nav>
        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless align-middle">
                            ...
                            <tbody>
                                @foreach ($lappenghuni_cibiru1 as $item)
                                <tr>
            ...
            function confirmDelete(id_lappenghuni) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('lappenghuni_cibiru1.destroy', ':id_lappenghuni') }}".replace(':id_lappenghuni', id_lappenghuni);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
