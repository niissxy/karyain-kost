                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    <!-- Tombol Edit -->
                                        <a href="{{ url('transaksi_regol1/' . $item->id_transaksi . '/edit') }}" 
                                         class="btn btn-outline-success btn-sm">
                                         <i class="bi bi-pencil-square"></i>
                                        </a>
                                         &nbsp;
                                        <a href="{{ route('transaksi_regol1.exportPdf', $item->id_transaksi) }}" 
            ...
            function confirmDelete(id_transaksi) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('transaksi_regol1.destroy', ':id_transaksi') }}".replace(':id_transaksi', id_transaksi);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
