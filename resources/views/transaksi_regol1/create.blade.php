                ...
                <div class="col-md-10">
                    <ol class="breadcrumb float-md-end small mb-4 mt-4">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Tambah Data Transaksi Kost Regol 1
                        </li>
                    </ol>
                </div>
            </div> 
            ...
            <div class="col-lg-8 col-md-10 col-sm-12">
                ...
                <div class="card card-warning card-outline">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Tambah Data Transaksi Kost Regol 1</h5>
                        <a class="btn btn-warning btn-sm" href="{{ url('./transaksi_regol1') }}">
                            <i class="bi bi-arrow-left-circle-fill"></i> Back
                        </a>
                    </div>

                    <form action="{{ url('transaksi_regol1') }}" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="id_transaksi" required value="{{ $newKode }}">
                                </div>
                            </div>
                           ...
                           <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="nominal" type="text" required>
                                </div>
                            </div>
