                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="kondisi" name="kondisi">
                                        <option value='Baik' {{ old('kondisi', $aset_cibiru1->status) == 'Baik' ? 'selected' : '' }}>Baik</option>
                                        <option value='Perbaikan' {{ old('kondisi', $aset_cibiru1->status) == 'Perbaikan' ? 'selected' : '' }}>Perbaikan</option>
                                        <option value='Rusak' {{ old('kondisi', $aset_cibiru1->status) == 'Rusak' ? 'selected' : '' }}>Rusak</option>       
                                    </select>  
                                </div>
                            </div>
