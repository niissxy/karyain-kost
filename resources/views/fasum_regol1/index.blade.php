        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="./fasum_regol1">Master Data</a>
                </li>
                <li class="breadcrumb-item active">
                    Data Fasilitas Umum Kost Regol 1
                </li>
            </ol>
        </nav>
    </div>
            ...
            function confirmDelete(id_fasum) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.action = "{{ route('fasum_regol1.destroy', ':id_fasum') }}".replace(':id_fasum', id_fasum);
                        form.method = 'POST';
                        form.innerHTML = `
                            @csrf
                            @method('DELETE')
