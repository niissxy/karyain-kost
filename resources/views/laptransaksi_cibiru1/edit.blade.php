                ...
                <div class="col-md-10">
                    <ol class="breadcrumb float-md-end small mb-4 mt-4">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Edit Laporan Penghuni Kost Cibiru 1
                        </li>
                    </ol>
                </div>
            </div> 
                    ...
                    <form action="{{ url('penghuni_cibiru1/' .$penghuni_cibiru1->id_penghuni) }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="{{ old('nama_penghuni',$penghuni_cibiru1->nama_penghuni) }}"  name="nama_penghuni"  required autofocus>
                                </div>
                            </div>
